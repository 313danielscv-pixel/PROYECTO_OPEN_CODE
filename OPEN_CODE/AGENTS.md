...
## Que es 
Mi CV/portfolio personal, publicado con github pages em https://github.com/313danielscv-pixel/PROYECTO_OPEN_CODE. su público son recruiters y empresas : profesional y sobrio, no un juguete.                   
...
- Debe funcionar abriéndelo con doble clic y desplegado desde Github Pages tal cual.
- Responsive (movil, tablet, escritorio) y accesible (contraste suficiente, aria, lang="es").

## Estilo
- Todo el texto visible en español; nombres de clases y codigo en ingles.
...
- NUNCA añadas telefono, direccion postal ni DNI.
